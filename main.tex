...
% \includegraphics[width=0.3\textwidth]{images/parisNanterre-logo}
% \includegraphics[width=0.2\textwidth]{images/logo_afia_2x.png}
% \includegraphics[width=0.2\textwidth]{images/Final Logo.png}\\[2 cm]
\begin{figure}[!htb]
...
\\[3cm] 
\bigskip
{\huge \bfseries Mémoire de fin d'étude M2 MIAGE}\\[1cm]
\\[1.5cm]
