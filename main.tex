...
%%% First page %%%
%%%%%%%%%%%%%%%%%%
\includepdf{images/PageGardeM2.pdf}
%\begin{titlepage}
%\begin{center}
...
\begin{enumerate}
  ...
  \item \textbf{L'enrichissement et la maintenance de la bibliothèque dans le temps} : ceci peut être évalué à travers la popularité et l’activité du dépôt Github des bibliothèques. Il existe plusieurs outils permettant d'évaluer la bibliothèque tel que npm trends [12]. La figure ci-dessus montre le nombre d'étoiles, de forks  et d’issues pour chaque bibliothèque, ainsi que la dernière mise à jour. 
  \item \textbf{La licence utilisée} : 
  \item \textbf{La licence utilisée} : 
  \item \textbf{La licence utilisée} : 
  \item \textbf{La licence utilisée} : 
  \item \textbf{La licence utilisée} : 
...
\end{enumerate}
 ...
 : 
L'enrichissement et la maintenance de la bibliothèque dans le temps : 
